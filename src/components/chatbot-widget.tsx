...
const botResponses = [
  ...
  "Puedo ayudarte con informacion sobre caracteristicas o soporte tecnico. Que necesitas?",
  "Tenemos integraciones con Slack, WhatsApp, Telegram y muchas mas. La configuracion es muy sencilla.",
  "Nuestro motor de IA procesa mas de 50 idiomas con deteccion automatica.",
  "Si, ofrecemos soporte dedicado para ayudarte en cada paso de la integracion.",
]
...
export function ChatbotWidget() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className={`fixed bottom-24 right-6 z-50 w-[380px] max-w-[calc(100vw-48px)] overflow-hidden rounded-2xl border border-border bg-card shadow-2xl transition-all ${
